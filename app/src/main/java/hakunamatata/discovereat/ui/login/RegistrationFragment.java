...
import static hakunamatata.discovereat.util.Constants.MINIMUM_PASSWORD_LENGTH;
import static hakunamatata.discovereat.util.Constants.PASSWORD;
import static hakunamatata.discovereat.util.Constants.USER_COLLISION_ERROR;
import static hakunamatata.discovereat.util.Constants.WEAK_PASSWORD_ERROR;
...
import hakunamatata.discovereat.databinding.FragmentRegistrationBinding;
...
public class RegistrationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        videoView = (VideoView) view.findViewById(R.id.logoAnimated2);
                            ...
                            getViewLifecycleOwner(), result -> {
                                if (result.isSuccess()) {
                                    ...
                                    Navigation.findNavController(view).navigate(
                                            R.id.action_registrationFragment_to_homeActivity);
                                } else {
